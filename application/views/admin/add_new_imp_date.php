...
<head>
  ...
  <title>Add New Important Date | IRO | TISS</title>
  ...
  <link rel="stylesheet" href="<?php echo SITE_PATH_CSS; ?>bootstrap-datepicker.css" rel="stylesheet">
	  	...
	  	<div class="content-wrapper">
		    ...
		    <section class="content-header">
		      	...
		      	<ol class="breadcrumb">
		        	...
		        	<li class="active">Add New Important Date</li>
			        ...
			        <div class="col-xs-12">
			          	...
			          	<div class="box">
				            ...
				            <div class="box-header">
				              ...
				              <h3 class="box-title">Add New Important Date</h3>
				            ...
				            <div class="box-body">
				              	...
				              	<form action="<?php echo base_url('save-important-date'); ?>" method="POST" name="add_new_important_date_form" id="add_new_important_date_form" enctype="multipart/form-data">

				              		<div class="form-group">

				              			<label for="">Important Date Title <span style="color:red;">*</span></label>

				              			<input type="text" name="title" id="title" class="form-control" placeholder="Enter Important Date Title" data-error='.error1'>
				              		...
				              		<div class="form-group">
										<label for="">Choose Important Date <span style="color:red;">*</span></label>
										<div class="input-group input-append date datePicker" >
											<input type="text" name="important_date" id="important_date" maxlength="10" class="date-own form-control " placeholder="Choose Important Date" data-error='.error2' />
				              		...
				              		<div class="form-group">
				              			...
				              			<label for="">Important Date Short Description <span style="color:red;">*</span></label>

				              			<textarea name="short_desc" id="short_desc" class="form-control" placeholder="Enter Important Date Short Description" data-error='.error3'></textarea>
				              		...
				              		<div class="form-group">
				              			...
				              			<select name="status" id="status" class="form-control" data-error='.error4' >
...
<script src="<?php echo SITE_PATH_JS; ?>bootstrap-datepicker.min.js"></script>
