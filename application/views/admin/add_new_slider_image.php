...
<head>
  ...
  <title>Add New Slider Image | IRO | TISS</title>
			        ...
			        <div class="col-xs-12">
			          	...
			          	<div class="box">
				            ...
				            <div class="box-body">
				              	...
				              	<form action="<?php echo base_url('save-slider-image'); ?>" method="POST" name="add_new_slider_img_form" id="add_new_slider_img_form" enctype="multipart/form-data">

				              		<div class="form-group">

				              			<label for="">Choose Image <span style="color:red;">*</span></label>

				              			<input type="file" name="slider_img" id="slider_img" class="form-control" data-error='.error1'>
				              		...
				              		<div class="form-group">
				              			...
				              			<select name="status" id="status" class="form-control" data-error='.error2' >
