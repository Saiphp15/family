...
<head>
  ...
  <title>Add New Upcomig Events | IRO | TISS</title>
	  	...
	  	<div class="content-wrapper">
		    ...
		    <section class="content-header">
		      	...
		      	<ol class="breadcrumb">
		        	...
		        	<li class="active">Add New Upcomig Events</li>
			        ...
			        <div class="col-xs-12">
			          	...
			          	<div class="box">
				            ...
				            <div class="box-header">
				              ...
				              <h3 class="box-title">Add New Upcomig Events</h3>
				            ...
				            <div class="box-body">
				              	...
				              	<form action="<?php echo base_url('save-upcomig-event'); ?>" method="POST" name="add_new_upcomig_event_form" id="add_new_upcomig_event_form" enctype="multipart/form-data">

				              		<div class="form-group">

				              			<label for="">Upcomig Events Title <span style="color:red;">*</span></label>

				              			<input type="text" name="title" id="title" class="form-control" placeholder="Enter Upcomig Event Title" data-error='.error1'>
				              		...
				              		<div class="form-group">
										<label for="">Choose Upcomig Event Date <span style="color:red;">*</span></label>
										<div class="input-group input-append date datePicker" >
											<input type="text" name="event_date" id="event_date" maxlength="10" class="date-own form-control " placeholder="Choose Upcomig Event Date" data-error='.error2' />
				              		...
				              		<div class="form-group">
				              			...
				              			<label for="">Upcomig Event Short Description <span style="color:red;">*</span></label>

				              			<textarea name="short_desc" id="short_desc" class="form-control" placeholder="Enter Upcomig Event Short Description" data-error='.error3'></textarea>
