...
<head>
  ...
  <title>View All Slider Images | IRO | TISS</title>
			        ...
			        <div class="col-xs-12">
			          	...
			          	<div class="box">
				            ...
				            <div class="box-header">
				              ...
				              <h3 class="box-title">View All Slider Images</h3>
				            ...
				            <div class="box-body">
				            	<div class="row">
				            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
										<table id="viewAllMouList" class="table table-bordered table-striped">
											<thead>
												<tr>
											...
											<tbody>
												...
												if(isset($slider_img_list) && !empty($slider_img_list)){
												
													$data = array();
													$i=1;
											      	foreach($slider_img_list as $resultData) 
											      	{
											      		$img_id = $resultData->id;
											      		$viewSingleImageUrl = base_url('add-new-slider-image/view/').$img_id;
											      		$editSingleImageUrl = base_url('add-new-slider-image/edit/').$img_id;
											      		$deleteSingleImageUrl = "'".base_url("delete-single-slider-image")."'";

											      		$path = SERVER_ROOT_PATH_UPLOADS.'slider_images/';
									 
											      		$action = '<a href="javascript:void(0);" class="btn btn-danger btn-xs deleteSingleSliderImage" data-imgid="'.$img_id.'" data-actionpage="'.$deleteSingleImageUrl.'" type="button" title="Delete This Image" ><span class="glyphicon glyphicon-trash"></span></a>';
											      	...
											      	?>
											      		<tr>
											      			<td><?php echo $i; ?></td>
											      			<td>
											      				<img src="<?php echo base_url().'uploads/slider_images/'.$resultData->slider_img; ?>" alt="Slider Image" class="img-responsive" style="width:auto;min-width:300px;max-width: 300px;height: auto;min-height: 150px;max-height: 150px;">
											      				<a href="<?php echo base_url().'uploads/slider_images/'.$resultData->slider_img; ?>" target="_blank">click to view</a>
											      			</td>
