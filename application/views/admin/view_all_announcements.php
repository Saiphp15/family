...
<head>
  ...
  <title>View All Announcements | IRO | TISS</title>
	  	...
	  	<div class="content-wrapper">
		    ...
		    <section class="content-header">
		      	...
		      	<ol class="breadcrumb">
		        	...
		        	<li class="active">View All Announcements</li>
				            ...
				            <div class="box-body">
				            	<div class="row">
				            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
										<table id="viewAllAnnouncementList" class="table table-bordered table-striped">
											<thead>
												<tr>
											...
											<tbody>
												...
												if(isset($announcement_list) && !empty($announcement_list)){
												
													$data = array();
													$i=1;
											      	foreach($announcement_list as $resultData) 
											      	{
											      		$announcement_id = $resultData->id;
											      		$viewSingleannouncementUrl = base_url('add-new-announcement/view/').$announcement_id;
											      		$editSingleannouncementUrl = base_url('add-new-announcement/edit/').$announcement_id;
											      		$deleteSingleannouncementUrl = "'".base_url("delete-single-announcement")."'";

											      		$action = '<a href="javascript:void(0);" class="btn btn-danger btn-xs deleteSingleAnnouncement" data-imgid="'.$announcement_id.'" data-actionpage="'.$deleteSingleannouncementUrl.'" type="button" title="Delete This Announcement" ><span class="glyphicon glyphicon-trash"></span></a>';
											      	...
											      	?>
											      		<tr>
											      			...
											      			<td><?php echo $resultData->short_desc; ?></td>
