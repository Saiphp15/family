...
<head>
  ...
  <title>View All Upcomig Events | IRO | TISS</title>
	  	...
	  	<div class="content-wrapper">
		    ...
		    <section class="content-header">
		      	...
		      	<ol class="breadcrumb">
		        	...
		        	<li class="active">View All Upcomig Events</li>
			        ...
			        <div class="col-xs-12">
			          	...
			          	<div class="box">
				            ...
				            <div class="box-header">
				              ...
				              <h3 class="box-title">View All Upcomig Events</h3>
				            ...
				            <div class="box-body">
				            	<div class="row">
				            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
										<table id="viewAllUpcomigEventList" class="table table-bordered table-striped">
											<thead>
												<tr>
											...
											<tbody>
												...
												if(isset($upcomig_event_list) && !empty($upcomig_event_list)){
												
													$data = array();
													$i=1;
											      	foreach($upcomig_event_list as $resultData) 
											      	{
											      		$event_id = $resultData->id;
											      		$viewSingleEventUrl = base_url('add-new-upcomig-event/view/').$event_id;
											      		$editSingleEventUrl = base_url('add-new-upcomig-event/edit/').$event_id;
											      		$deleteSingleEventUrl = "'".base_url("delete-single-event")."'";

											      		$action = '<a href="javascript:void(0);" class="btn btn-danger btn-xs deleteSingleEvent" data-imgid="'.$event_id.'" data-actionpage="'.$deleteSingleEventUrl.'" type="button" title="Delete This Event" ><span class="glyphicon glyphicon-trash"></span></a>';
											      	...
											      	?>
											      		<tr>
											      			...
											      			<td><?php echo $resultData->event_date; ?></td>
